...
-->
		...
		<?php
			$screen_logo_array = [ ["screen 1_1.png", 250 , "logo_icons_1_1"], ["screen 4_3.png", 334 , "logo_icons_4_3"], ["screen 16_9.png", 443 , "logo_icons_16_9"]] ;
		...
		<?php
			...
			echo "<img class='smb-logo-left-screen' width=\"" . $screen_logo_array[$screen_rand_1][1] . "px\"  alt='Shared Memory Blog logo left screen' src=\"" . get_bloginfo("template_directory") . "/images/" . $screen_logo_array[$screen_rand_1][0] . "\" />";
			echo "<img class='smb-logo-right-screen' width=\"" . $screen_logo_array[$screen_rand_2][1] . "px\" alt='Shared Memory Blog logo left screen' src=\"" . get_bloginfo("template_directory") . "/images/" . $screen_logo_array[$screen_rand_2][0] . "\" style=\"left: " . ($screen_logo_array[$screen_rand_1][1] + 489 - 1)  . "px;\" />";
...
<!--
			...
			?>
-->
				<div class="smb-logo-icon11" style="width: <?php echo ($screen_logo_array[$screen_rand_1][1] - 7); ?>px;"> <!--<?php if(isset($image_rand_1)) echo "<img alt=\"Shared Memory Blog icons 1\" src=\"" . get_bloginfo('template_directory') . "/logo_icons/$image_rand_1\"/>"; ?> --></div>
				<div class="smb-logo-icon22" style="width: <?php echo ($screen_logo_array[$screen_rand_2][1] - 7); ?>px;"> <!--<?php if(isset($image_rand_2)) echo "<img alt=\"Shared Memory Blog icons 2\" src=\"" . get_bloginfo('template_directory') . "/logo_icons/$image_rand_2\"/>"; ?> --></div>
		</a>
		</div>
